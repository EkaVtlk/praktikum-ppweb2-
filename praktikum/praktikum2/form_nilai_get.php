...
<body>
    ...
    <main role="main" class="container mt-3">
        ...
        <form class="mx-auto" action="Form_nilai_get.php" method="GET">
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input id="name" name = "nama" placeholder="Nama Lengkap" type="text" required="required" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <label for="matkul" class="col-5 col-form-label font-weight-bold text-right">Mata Kuliah</label>
                <div class="col-7">
                    <select id="matkul" name= "matkul $_GET['nilai_tugas']" class="custom-select" required="required">
    ...
    <footer class="mt-5">
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="#">Develop By @ekaav &copy;<?= date("Y") ?></a>
            </div>
        </nav>
    </footer>
